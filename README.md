...
| [Case 02: Lumma Stealer - ClickFix Phishing](./02-Lumma-Stealer-ClickFix-Phishing) | Investigated a phishing email leading to DLL side-loading and Lumma Stealer deployment via the ClickFix technique | LetsDefend SOC Simulator, VirusTotal, Threat Intel |
## Skills Demonstrated
...
- Phishing and threat intelligence analysis
